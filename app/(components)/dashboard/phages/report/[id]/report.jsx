...
import { StyleSheet, Font, Page, Document, Text } from "@react-pdf/renderer";
const PhageReport = ({ phage }) => {
  return (
    <Document>
      <Page size="A4" style={styles.body}>
        ...
        <Image style={styles.image} src="/logo.v3.png" />
